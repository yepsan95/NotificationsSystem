...
@router.post("/login", response_model=AuthMessageResponse, status_code=status.HTTP_200_OK)
def login(
...
@router.post("/refresh", response_model=AuthMessageResponse, status_code=status.HTTP_200_OK)
def refresh_session(
    response: Response,
